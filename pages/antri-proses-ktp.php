...
<body>
    ...
    if ($set) {
        ...
        Swal.fire('Pengambilan Nomor Berhasil!','Anda akan menerima SMS yang berisi detail Antrian Anda.','success').then(function(){ window.location = 'data-antrian-ktp.php'; })</script>";
    } else {
        echo "<script language='javascript'>
        window.alert('Gagal mengambil Nomor Antrian')</script>";
        echo "<script language='javascript'>
        location.href='halaman-user-ktp.php'</script>";
    }
    ?>
