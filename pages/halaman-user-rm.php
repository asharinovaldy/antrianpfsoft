...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="halaman-user-rm.php">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item tab-menu active" href="data-antrian-rm.php">Antrian Anda</a>
          </div>
        </div>
      </li>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <table class="table table-striped table-bordered table-hover">
              ...
              $query = mysqli_query($koneksi, "SELECT * FROM pasien WHERE rm_file='$rm'");
          ...
          <div class="row">
            ...
            $cek = mysqli_query($koneksi, "SELECT * FROM antrionline WHERE no_rm='$rm' AND tgl_antri='$tgl'");
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="antri-proses-rm.php" method="POST">
