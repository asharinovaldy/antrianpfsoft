            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item tab-menu" href="data-antrian-bpjs.php">Antrian Anda</a>
                    </div>
                </div>
            </li>
                            ...
                            <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered ">
                                    ...
                                    <tbody>
                                        ...
                                        $check = mysqli_query($koneksi, "SELECT no_rm FROM antrionline WHERE no_bpjs = '$bpjs' AND tgl_antri = '$date'");
