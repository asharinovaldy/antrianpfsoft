      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item tab-menu active" href="data-antrian-ktp.php">Antrian Anda</a>
          </div>
        </div>
      </li>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <table class="table table-striped table-bordered table-hover">
              ...
              $query = mysqli_query($koneksi, "SELECT * FROM pasien WHERE no_ktp='$ktp'");
          ...
          <div class="row">
            ...
            $check = mysqli_query($koneksi, "SELECT no_rm FROM antrionline WHERE no_ktp = '$ktp' AND tgl_antri = '$tgl'");
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="antri-proses-ktp.php" method="POST">
